...
```javascript
const quest =
"Forge a marketplace where warriors of gaming
trade their legendary relics. 🎮⚔️"
```
...
```javascript
const quest =
"Build a sanctuary for diverse travelers,
guiding them to new horizons. 🌈✈️"
```
...
```javascript
const quest =
"Forge a companion for the bravest warriors —
a Death Counter that chronicles every fall and
every rise in the harsh lands of the Souls universe. ☠️⚔️"
```
